...
wstring ExtractDataHex(const wstring& input)
{
	wstring key = L"data=\"";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
wstring ExtractTextFromXMLTag(const wstring& input, const wstring& tag) 
{
	wstring openTag = L"<" + tag + L">";
	wstring closeTag = L"</" + tag + L">";

	size_t start = input.find(openTag);
	size_t end = input.find(closeTag);
