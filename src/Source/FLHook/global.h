...
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreDALib.lib")
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreCommon.lib")
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreDACom.lib")
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreFLServerEXE.lib")
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreRemoteClient.lib")
#pragma comment(lib,"FLHookPluginSDK/libs/FLCoreServer.lib")
...
#else
#define VERSION L"9.0.0 Dvurechensky Hook"
#endif
...
EXPORT wstring stowsUTF8(const std::string& utf8Text);
EXPORT string wstos(const wstring &wscText);
EXPORT string itos(int i);
EXPORT string lltos(long long i);
...
EXPORT long long IniGetLL(const string &scFile, const string &scApp, const string &scKey, long long iDefault);
...
EXPORT wstring FormatMilliseconds(int ms);
...
extern EXPORT bool	set_bUserCmdSetAudioMsg;
...
extern EXPORT wstring set_wscUserCmdKeyStyle;
extern EXPORT wstring set_wscUserCmdValueStyle;
extern EXPORT wstring set_wscUserCmdTypeStyle;
