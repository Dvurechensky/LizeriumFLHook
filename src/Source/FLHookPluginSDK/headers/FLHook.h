...
IMPORT wstring ExtractTextFromXMLTag(const wstring& input, const wstring& tag = L"TEXT");
IMPORT wstring ExtractDataHex(const wstring& input);
...
IMPORT void HkPlayerAudioMsg(uint iClientID, const char* Audio);
IMPORT void HkPlayerChatTime(uint iClientID);
...
IMPORT void PrintUserCmdTextColorKV(uint iClientID, const wstring& wscKey, const wstring& wscValue);
IMPORT void PrintUserCmdTextColorKVCustom(uint iClientID, const wstring& wscKey, const wstring& wscColorKey, const wstring& wscValue, const wstring& wscColorValue);
EXPORT void PrintUserCmdTextColor4KV(uint iClientID, const wstring& wscKey1, const wstring& wscKey2, const wstring& wscKey3, const wstring& wscKey4);

// HkLocalized :: Database 
IMPORT wstring GetLocalized(uint iClientID, const string& wscKey);

// HkUserCmd :: Database 
IMPORT bool CheckUserExistInDb(uint iClientID);
IMPORT bool AddUserInDb(uint iClientID);

// tools
IMPORT wstring stows(const string &scText);
IMPORT wstring stowsUTF8(const std::string& utf8Text);
IMPORT string wstos(const wstring &wscText);
IMPORT string itos(int i);
IMPORT string lltos(long long i);
...
IMPORT long long IniGetLL(const string &scFile, const string &scApp, const string &scKey, long long iDefault);
...
IMPORT wstring FormatMilliseconds(int ms);
...
extern IMPORT bool  set_bUserCmdSetAudioMsg;
extern IMPORT bool  set_bUserCmdSetChatTime;
