...
{
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1288"), GetLocalized(iClientID, "MSG_1289"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1290"), GetLocalized(iClientID, "MSG_1291"));
	PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0091"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1292"), GetLocalized(iClientID, "MSG_1293"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1294"), GetLocalized(iClientID, "MSG_1295"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1296"), GetLocalized(iClientID, "MSG_1297"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1298"), GetLocalized(iClientID, "MSG_1299"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1300"), GetLocalized(iClientID, "MSG_1301"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1302"), GetLocalized(iClientID, "MSG_1303"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1304"), GetLocalized(iClientID, "MSG_1305"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1306"), GetLocalized(iClientID, "MSG_1307"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1308"), GetLocalized(iClientID, "MSG_1309"));
	PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0092"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1310"), GetLocalized(iClientID, "MSG_1311"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1312"), GetLocalized(iClientID, "MSG_1313"));
	PrintUserCmdTextColorKV(iClientID, GetLocalized(iClientID, "MSG_1314"), GetLocalized(iClientID, "MSG_1315"));
}
...
bool  UserCmd_AutoBuy(uint iClientID, const wstring &wscCmd, const wstring &wscParam, const wchar_t *usage)
{
	if (!bPluginEnabled)
	{
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0093"));
		return true;
	}
	...
	{
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0094"), mapAutobuyPlayerInfo[iClientID].bAutoBuyMissiles ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0095"), mapAutobuyPlayerInfo[iClientID].bAutoBuyMines ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0096"), mapAutobuyPlayerInfo[iClientID].bAutoBuyTorps ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0097"), mapAutobuyPlayerInfo[iClientID].bAutoBuyCD ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0098"), mapAutobuyPlayerInfo[iClientID].bAutoBuyCM ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0099"), mapAutobuyPlayerInfo[iClientID].bAutobuyMunition ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0100"), mapAutobuyPlayerInfo[iClientID].bAutobuyCloak ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0101"), mapAutobuyPlayerInfo[iClientID].bAutobuyBB ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0102"), mapAutobuyPlayerInfo[iClientID].bAutoRepair ? GetLocalized(iClientID, "MSG_1513") : GetLocalized(iClientID, "MSG_1514"));
		return true;
	}
	...
	PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0103"));
	return true;
}
		...
		for (list<EquipDesc>::iterator item = Players[iClientID].equipDescList.equip.begin(); item != Players[iClientID].equipDescList.equip.end(); item++)
		{
			if (item->iArchID == ammo)
			{
				if (item->iCount > (mapAmmolimits[ammo] * tempmap[ita->first]))
				{
					...
					PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0104"));
...
void PlayerAutorepair(uint iClientID)
{
	...
	if (iCash < repairCost)
	{
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0105"));
		return;
	}

	HkAddCash(wscCharName, -repairCost);

	// Не делаем этого в приведенном выше цикле, потому что нам нужно убедиться, что у игрока есть кредиты для этого.
	for (list<EquipDesc>::iterator item = equip.begin(); item != equip.end(); item++)
	...
	if (repairCost)
		PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0106"), ToMoneyStr(repairCost).c_str());
	...
	{ // shield bats & nanobots
		...
		foreach(lstCargo, CARGO_INFO, it)
		{
			...
			if ((*it).iArchID == iNanobotsID) {
				...
				aci.wscDescription = GetLocalized(iClientID, "MSG_1515");
				lstCart.push_back(aci);
				bNanobotsFound = true;
			}
				...
				aci.wscDescription = GetLocalized(iClientID, "MSG_1516");
				lstCart.push_back(aci);
		...
		foreach(lstMounted, CARGO_INFO, it2)
		{
			...
			if (eq_type == ET_MINE)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutoBuyMines)
					ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1517"))
			}
			else if (eq_type == ET_CM)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutoBuyCM)
					ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1518"))
			}
			else if (eq_type == ET_TORPEDO)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutoBuyTorps)
				{
					...
					{
						ADD_EQUIP_TO_CART_STACKABLE(GetLocalized(iClientID, "MSG_1519"))
					}
					else
					{
						ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1519"))
					}
				}
			}
			else if (eq_type == ET_CD)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutoBuyCD)
					ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1520"))
			}
			else if (eq_type == ET_MISSILE)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutoBuyMissiles)
				{
					if (mapStackableItems.find(eq->get_id()) != mapStackableItems.end())
					{
						ADD_EQUIP_TO_CART_STACKABLE(GetLocalized(iClientID, "MSG_1521"))
					}
					else
					{
						ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1521"))
					}
				}
			}
			else if (eq_type == ET_GUN)
			{
				if (mapAutobuyPlayerInfo[iClientID].bAutobuyMunition)
				{
					if (mapStackableItems.find(eq->get_id()) != mapStackableItems.end())
					{
						ADD_EQUIP_TO_CART_STACKABLE(GetLocalized(iClientID, "MSG_1522"))
					}
					else
					{
						ADD_EQUIP_TO_CART(GetLocalized(iClientID, "MSG_1522"))
					}
				}
			}
			...
			if (mapAutobuyFLHookExtras.find(eq->iArchID) != mapAutobuyFLHookExtras.end())
			{
				...
				if (mapAutobuyPlayerInfo[iClientID].bAutobuyCloak)
					ADD_EQUIP_TO_CART_FLHOOK(GetLocalized(iClientID, "MSG_1523"))
			}
		}
	}
	...
	foreach(lstCart, AUTOBUY_CARTITEM, it4)
	{
		...
		foreach(bi->lstMarketMisc, DATA_MARKETITEM, itmi)
		{
			if (itmi->iArchID == it4->iArchID)
			{
				...
				if (iBaseRep == -1)
					continue; // Rep пока не может быть определен(космический объект еще не создан?)
		...
		if (iRemHoldSize < (eq->fVolume * (*it4).iCount))
		{
			...
			if (!iNewCount) {
				//				PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0107"), (*it4).wscDescription.c_str());
				continue;
			}
			else
		...
		if (iCash < iCost)
			PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0108"), (*it4).wscDescription.c_str());
		else {
			...
			if ((*it4).iCount != 0)
			{
				PrintUserCmdText(iClientID, GetLocalized(iClientID, "MSG_0109"), (*it4).wscDescription.c_str(), (*it4).iCount, ToMoneyStr(iCost).c_str());
			}
		}
	}
