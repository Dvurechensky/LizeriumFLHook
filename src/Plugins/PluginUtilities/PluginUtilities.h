...
void PrintLocalUserCmdColorText(uint iClientID, const wstring& timeMsg, const wstring& typeMsg, const wstring& playerNameMsg, const wstring& wscMsg, float fDistance);
